    ...
    public partial class Single : System.Web.UI.Page
    {
...

        {
            ...
            else
            {
                ...
                display += "<div>";
                display += "<ul>";
                display += "  <li> <i> Author Name :</i>" + SingleProduct.P_AuthorName + "</li>";
                display += "  <li> <i>Book Name:</i>" + SingleProduct.P_name + "</li>";
                display += "  <li> <i>Category :</i>" + SingleProduct.P_category + "</li>";
                display += "  <li> <i>Language :</i>" + SingleProduct.P_Language + "</li>";

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPageM.Master" AutoEventWireup="true" CodeBehind="AdminProductM.aspx.cs" Inherits="Spark_Fiddle.AdminProductM" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="quantinty" runat="server" placeholder="Book Cost(per unit)" TextMode="Number" ></asp:TextBox>
                        </div>
                     </div>
